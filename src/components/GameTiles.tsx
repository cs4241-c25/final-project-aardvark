...
function EmptyRankedTile({
  ...
  return (
    <button
      className={clsx(
        "h-12 md:h-16 rounded border-2 hover:border-4 transition-all dark:border-white/40 border-black/40 uppercase font-bold text-black/40 dark:text-white/40",
        currentDestination === id ? "border-4 dark:bg-white/20 bg-black/20" : ""
      )}
